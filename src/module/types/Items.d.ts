...
import { INITIAL_INVOCATION_DATA } from './mystic/InvocationItemConfig';
import { INITIAL_ENTITY_POWER_DATA } from './mystic/EntityPowerItemConfig';
...
export type EntityPowerItemData = typeof INITIAL_ENTITY_POWER_DATA;
export type EntityPowerDataSource = ABFItemBaseDataSource<EntityPowerItemData>;
export type EntityPowerChanges = ItemChanges<EntityPowerItemData>;
export type EntityPowerItemConfig = ABFItemConfig<EntityPowerItemData>;

export type InvocationItemData = typeof INITIAL_INVOCATION_DATA;
export type InvocationDataSource = ABFItemBaseDataSource<InvocationItemData>;
export type InvocationChanges = ItemChanges<InvocationItemData>;
export type InvocationItemConfig = ABFItemConfig<InvocationItemData>;
