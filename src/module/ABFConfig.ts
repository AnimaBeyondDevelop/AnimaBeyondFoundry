...
import { CombatVisibility, SustenanceTypes } from './types/domine/TechniqueItemConfig';
...
const sustenanceTypes = {
  [SustenanceTypes.NONE]: 'anima.ui.domine.sustenance.none.title',
  [SustenanceTypes.LESSER]: 'anima.ui.domine.sustenance.lesser.title',
  [SustenanceTypes.GREATER]: 'anima.ui.domine.sustenance.greater.title'
};

ABFConfig.ui = { CombatVisibility };
  ...
  psychic: {
    ...
    disciplines: {
      [PsychicPowerDisciplines.THE_MATRIAL_POWERS]:
        'anima.ui.psychic.psychicPowers.discipline.matrial.title',
      ...
      [PsychicPowerDisciplines.HIPERSENSIBILIDAD]:
        'anima.ui.psychic.psychicPowers.discipline.hipersensibilidad.title'
    },
    criticTypes,
    criticTypesWithNone: {
      [NoneWeaponCritic.NONE]: 'anima.ui.combat.armors.at.none.title',
