...
describe('ABFRoll', () => {
  test('must explode roll if first result is bigger or equals to 90', () => {
    ...
    expect(abfRollProxy.getRoll().result.length).toBe(2);
    expect(abfRollProxy.getRoll().result[0]).toBe(90);
  ...
  test('must not explode roll if first result is less than 90', () => {
    ...
    expect(abfRollProxy.getRoll().result.length).toBe(1);
    expect(abfRollProxy.getRoll().result[0]).toBe(89);
  ...
  test('must explode multiple times increasing open range', () => {
    ...
    expect(abfRollProxy.getRoll().result.length).toBeGreaterThan(7);
    expect(abfRollProxy.getRoll().total).toBeGreaterThan(
    ...
    expect(abfRollProxy.getRoll().result.length).toBeGreaterThan(8);
    expect(abfRollProxy.getRoll().total).toBeGreaterThan(
    ...
    expect(abfRollProxy.getRoll().result.length).toBeGreaterThan(9);
    expect(abfRollProxy.getRoll().total).toBeGreaterThan(
    ...
    expect(abfRollProxy.getRoll().result.length).toBeGreaterThan(10);
    expect(abfRollProxy.getRoll().total).toBeGreaterThan(
