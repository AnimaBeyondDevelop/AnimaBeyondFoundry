...
export default class ModifyDicePermissionsConfig extends FormApplication {
  ...
  get settings() {
    return game.settings.get("abf", ABFSettingsKeys.MODIFY_DICE_FORMULAS_PERMISSION) || {};
  }
  ...
  async _updateObject(event, formData) {
    ...
    await game.settings.set("abf", ABFSettingsKeys.MODIFY_DICE_FORMULAS_PERMISSION, newSettings);
  }
}