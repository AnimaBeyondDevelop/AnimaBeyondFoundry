  ...
  return {
    ...
    attacker: {
      ...
      mystic: {
        ...
        critic: game.abf.weapon.NoneWeaponCritic.NONE,
        resistanceEffect: { value: 0, type: undefined, check: false },
        visible: false,
        distanceCheck: false,
        projectile: {
...
export class CombatAttackDialog extends FormApplication {
  constructor(attacker, defender, hooks, options = {}) {
    ...
    if (spells.length > 0) {
      ...
      mystic.critic = spell?.system.critic.value ?? game.abf.weapon.NoneWeaponCritic.NONE;
  ...
  activateListeners(html) {
    ...
    html.find('.send-attack').click(async () => {
      ...
      if (typeof damage !== 'undefined') {
        ...
        if (
          weapon !== undefined &&
          criticSelected !== game.abf.weapon.NoneWeaponCritic.NONE &&
        ...
        const critic = criticSelected ?? game.abf.weapon.WeaponCritic.IMPACT;
  ...
  getData() {
    ...
    if (combat.unarmed) {
      ...
      ui.weaponHasSecondaryCritic =
        weapon.system.critic.secondary.value !== game.abf.weapon.NoneWeaponCritic.NONE;
  ...
  async _updateObject(event, formData) {
    ...
    if (prevSpell !== this.modalData.attacker.mystic.spellUsed) {
      ...
      this.modalData.attacker.mystic.critic =
        spell?.system.critic.value ?? game.abf.weapon.NoneWeaponCritic.NONE;
