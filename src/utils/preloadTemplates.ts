...
export const preloadTemplates = () => {
  const templatePaths: string[] = [
    ...
    Templates.Dialog.PsychicCast,
    Templates.Dialog.newPreparedSpell,
    Templates.Dialog.newMaintainedSpell,
    Templates.Dialog.newInnatePsychicPower,
    ...
    'systems/animabf/templates/common/domain/weapon/select-poison.hbs',
    ...
    'systems/animabf/templates/items/poison/poison.hbs',
    ...
    'systems/animabf/templates/actor/parts/combat/parts/poisons.hbs',
    ...
    'systems/animabf/templates/actor/parts/mystic/parts/maintained-spells.hbs',
